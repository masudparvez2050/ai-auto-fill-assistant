...
function createEnhancementPrompt(fieldContext, currentContent) {
  let prompt = `Please enhance the following content to make it more professional, well-written, and engaging. Maintain the same meaning and intent, but improve the writing quality, grammar, clarity, and overall effectiveness.\n\n`;
